...
(() => {
    document.getElementById("run").addEventListener("click", () => {
        ...
        people.forEach(function (element) { // pour chaque élément du tableau people
            console.log(element.lastname); //afficher le nom de chaque éléments un a la suite des autres
        });
